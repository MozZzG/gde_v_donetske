...
class Text extends \Faker\Provider\Text
{
     ...
     * DIRITTI D'AUTORE: no
     *
     * LICENZA: questo testo è distribuito con la licenza specificata al seguente indirizzo Internet: http://web.liberliber.it/libri/licenze/ (Attribution-NonCommercial-ShareAlike 4.0 International)
     *
     ...
     *
     * PUBBLICAZIONE:
     * Marco Calvo, http://web.marcocalvo.it/
     ...
     *
     * @see http://web.liberliber.it/libri/c/collodi/index.php#elenco_opere
     * @var string
     */
