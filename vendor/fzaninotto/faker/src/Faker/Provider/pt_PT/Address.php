...
class Address extends \Faker\Provider\Address
{
    ...
    /** @link http://web.univ-ab.pt/PINTAC/carta_normas.htm address example in letters **/
    protected static $addressFormats = array(
        "{{streetAddress}}\n{{postcode}} {{city}}",
    );

    /** @link http://web.mapadeportugal.net/indicecidades.asp **/
    ...
    /** @link http://web.indexmundi.com/pt/ **/
