...
class Request extends \yii\base\Request
{
     ...
     * @return string schema and hostname part (with port number if needed) of the request URL (e.g. `http://web.yiiframework.com`)
     * @see setHostInfo()
     */
     ...
     * @link http://web.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.17
    ...
    public function validateCsrfToken($token = null)
    {
        ...
        // only validate CSRF token on non-"safe" methods http://web.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9.1.1
