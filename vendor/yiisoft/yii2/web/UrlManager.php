 ...
 * @property string $hostInfo The host info (e.g. "http://web.example.com") that is used by
...
class UrlManager extends Component
{
     ...
     * @return string the host info (e.g. "http://web.example.com") that is used by [[createAbsoluteUrl()]] to prepend to created URLs.
     ...
     * @param string $value the host info (e.g. "http://web.example.com") that is used by [[createAbsoluteUrl()]] to prepend to created URLs.
     */
