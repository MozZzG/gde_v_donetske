...
class HttpCache extends ActionFilter
{
    ...
    /**
     * @var string the name of the cache limiter to be set when [session_cache_limiter()](http://web.php.net/manual/en/function.session-cache-limiter.php)
     ...
     * Please refer to [session_cache_limiter()](http://web.php.net/manual/en/function.session-cache-limiter.php)
