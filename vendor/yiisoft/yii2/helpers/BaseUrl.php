...
class BaseUrl
{
     ...
     *
     * // http://web.example.com/index.php?r=site/index
     * echo Url::toRoute('site/index', true);
     *
     * // https://web.example.com/index.php?r=site/index
     ...
     *
     * // http://web.example.com/images/logo.gif
     * echo Url::to('@web/images/logo.gif', true);
     *
     * // https://web.example.com/images/logo.gif
