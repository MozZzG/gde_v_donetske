...
class Formatter extends Component
{
     ...
     *
     * This can be any value that may be passed to [date_default_timezone_set()](http://web.php.net/manual/en/function.date-default-timezone-set.php)
     * e.g. `UTC`, `Europe/Berlin` or `America/Chicago`.
     * Refer to the [php manual](http://web.php.net/manual/en/timezones.php) for available time zones.
     ...
     * Please refer to the [php manual](http://web.php.net/manual/en/timezones.php) for available time zones.
     *
