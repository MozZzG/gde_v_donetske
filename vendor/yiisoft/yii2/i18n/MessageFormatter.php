 ...
 *
 *   The fallback implementation does NOT support the ['apostrophe-friendly' syntax](http://web.php.net/manual/en/messageformatter.formatmessage.php).
...
class MessageFormatter extends Component
{
     ...
     *
     * It uses the PHP intl extension's [MessageFormatter](http://web.php.net/manual/en/class.messageformatter.php)
     ...
     *
     * It uses the PHP intl extension's [MessageFormatter::parse()](http://web.php.net/manual/en/messageformatter.parsemessage.php)
