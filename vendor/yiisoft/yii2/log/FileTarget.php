...
class FileTarget extends Target
{
     ...
     * a bit faster.
     *
     * The problem with windows systems where the [rename()](http://web.php.net/manual/en/function.rename.php)
     * function does not work with files that are opened by some process is described in a
     * [comment by Martin Pelletier](http://web.php.net/manual/en/function.rename.php#102274) in
