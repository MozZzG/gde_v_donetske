...
class QueryBuilder extends \yii\db\QueryBuilder
{
     ...
     * @see http://web.postgresql.org/docs/8.2/static/sql-createindex.html
     */
    ...
    public function resetSequence($tableName, $value = null)
    {
        ...
        if ($table !== null && $table->sequenceName !== null) {
            // c.f. http://web.postgresql.org/docs/8.1/static/functions-sequence.html
    ...
    public function alterColumn($table, $column, $type)
    {
        ...
        // http://web.postgresql.org/docs/9.1/static/sql-altertable.html
