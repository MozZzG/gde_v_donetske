...
class Connection extends Component
{
     ...
     * Please refer to the [PHP manual](http://web.php.net/manual/en/function.PDO-construct.php) on
     ...
     * [PHP manual](http://web.php.net/manual/en/function.PDO-setAttribute.php) for
     ...
     * @see http://web.php.net/manual/en/function.PDO-lastInsertId.php
     */
     ...
     * @see http://web.php.net/manual/en/function.PDO-quote.php
     */
