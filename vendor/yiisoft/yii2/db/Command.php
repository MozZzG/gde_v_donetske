...
class Command extends Component
{
     ...
     * @see http://web.php.net/manual/en/function.PDOStatement-setFetchMode.php
     */
     ...
     * @see http://web.php.net/manual/en/function.PDOStatement-bindParam.php
     */
     ...
     * @param integer $dataType SQL data type of the parameter. If null, the type is determined by the PHP type of the value.
     * @return $this the current command being executed
     * @see http://web.php.net/manual/en/function.PDOStatement-bindValue.php
     */
     ...
     * @param integer $fetchMode the result fetch mode. Please refer to [PHP manual](http://web.php.net/manual/en/function.PDOStatement-setFetchMode.php)
