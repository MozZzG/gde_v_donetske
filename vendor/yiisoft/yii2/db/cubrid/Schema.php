...
class Schema extends \yii\db\Schema
{
     ...
     * Please refer to [CUBRID manual](http://web.cubrid.org/manual/91/en/sql/datatype.html) for
     ...
     * @see http://web.php.net/manual/en/pdo.constants.php
     */
    ...
    /**
     * @inheritdoc
     * @see http://web.cubrid.org/manual/91/en/sql/transaction.html#database-concurrency
     */
