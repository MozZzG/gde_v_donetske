 ...
 * [[fetchMode]]. See the [PHP manual](http://web.php.net/manual/en/function.PDOStatement-setFetchMode.php)
...
class DataReader extends \yii\base\Object implements \Iterator, \Countable
{
     ...
     * @see http://web.php.net/manual/en/function.PDOStatement-bindColumn.php
     */
