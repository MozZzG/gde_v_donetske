...
test("class", function() {
	...
	div = jQuery("<div><svg width='200' height='250' version='1.1' xmlns='http://web.w3.org/2000/svg'><rect x='10' y='10' width='30' height='30' class='foo'></rect></svg></div>")[0];
...
test("attributes", function() {
	...
	t( "Attribute Equals", "#qunit-fixture a[rel='bookmark']", ["simon1"] );
	t( "Attribute Equals", "#qunit-fixture a[rel=bookmark]", ["simon1"] );
	t( "Attribute Equals", "#qunit-fixture a[href='http://web.google.com/']", ["google"] );
	t( "Attribute Equals", "#qunit-fixture a[ rel = 'bookmark' ]", ["simon1"] );
	...
	t( "Attribute Begins With", "a[href ^= 'http://web']", ["google","yahoo"] );
