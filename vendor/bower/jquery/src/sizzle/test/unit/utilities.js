...
if ( jQuery("<svg xmlns='http://web.w3.org/2000/svg' version='1.1' height='1' width='1'><g/></svg>")[0].firstChild ) {
	test("Sizzle.contains in SVG (jQuery #10832)", function() {
		expect( 4 );

		var svg = jQuery(
			"<svg xmlns='http://web.w3.org/2000/svg' version='1.1' height='1' width='1'>" +
